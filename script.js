window.addEventListener('load', function() {
    ...
    class Drone extends Enemy {
        constructor(game, x, y){
            ...
            this.score = this.lives;
            this.type = 'drone';
            this.speed = Math.random() * -4.2 - 0.2;
        }
    }
    ...
    class Background {
        constructor(game){
            ...
            // Creating the layers list to iterate through
    ...
    class Game {
        ...
        addExplosion(enemy){
            const randomize = Math.random();
            if (randomize < 0.5) {
                this.explosions.push(new SmokeExplosion(this, enemy.x + 
                enemy.width * 0.5, enemy.y + enemy.height * 0.5));
            } else {
                this.explosions.push(new FireExplosion(this, enemy.x + 
                    enemy.width * 0.5, enemy.y + enemy.height * 0.5));
            }
        }
